...
class HybridSequenceTagger(SequenceTagger):
    ...
    def change_biaffine_dropout_ratio(self, dropout_ratio):
        ...
        print('Set {} dropout ratio to {}'.format('Biaffine', self.predictor.biaffine_dropout), file=sys.stderr)
    ...
    def change_chunk_vector_dropout_ratio(self, dropout_ratio):
        ...
        print('Set {} dropout ratio to {}'.format(
            'Chunk vector', self.predictor.chunk_vector_dropout), file=sys.stderr)
    ...
    def grow_embedding_layers(
            ...
            external_chunk_model=None, train=True, fasttext=False):
        ...
        models.util.grow_embedding_layers(
            ...
            self.predictor.pretrained_embed_usage, train=train, fasttext=fasttext)


    def copy_parameters_from_basemodel(self, base):
        self.predictor.unigram_embed = base.unigram_embed
        # self.predictor.bigram_embed = base.bigram_embed
        # self.predictor.type_embed = base.type_embed
        # self.predictor.subtoken_embed = base.subtoken_embed
