...
RNN_UNITS=600
RNN_DROPOUT=0.4
TRAIN_DATA=data/sample/text1.segtag.wl
DEVEL_DATA=data/sample/text2.segtag.wl
INPUT_FORMAT=wl
POS_INDEX=1
...
#        --attribute_column_indexes $POS_INDEX \
#        --attribute_depths $POS_DEPTH
...
MODE=eval
TEST_DATA=data/sample/text2.segtag.wl
INPUT_FORMAT=wl
POS_INDEX=1
